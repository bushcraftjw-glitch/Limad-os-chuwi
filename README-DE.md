# LiMaD OS 3.0 RC1 BASE1 V19

## Technische Basis

V19 baut auf dem bereits funktionierenden Ubuntu-26.04-FULL-Unterbau auf. Installationsquelle bleibt ausschließlich `ubuntu-desktop` FULL. Canonicals Kernel-, Treiber-, EFI-/Secure-Boot- und OEM-/Drittanbieter-Treiberlogik wird nicht ersetzt.

V19 ergänzt gezielt zwei Bereiche: sichtbares LiMaD-Branding und einen nur für Apple `iMac17,1` aktivierten Grafik-Kompatibilitätspfad.

## LiMaD Design

V19 ist ein gezielter Design-Repair auf Basis des V15-Desktopstands. Der Desktop-Core (dconf, Dock, Icons) ist installationskritisch und vom optionalen GDM/Plymouth-Branding getrennt. Die GNOME-Grundeinstellungen werden vor dem ersten Login als systemweite, nicht gesperrte dconf-Defaults installiert und danach in zwei Durchläufen verifiziert. LiLink/LiDrop sind vom Desktop-Core entkoppelt und können Dock, Icons oder Fensterdesign nicht mehr blockieren.
...
Der Canonical-Installer-Snap wird nicht geforkt oder verändert. V19 nutzt die offizielle Whitelabel-Schnittstelle des Ubuntu Desktop Provision Installers:
...
LiDrop bleibt für Browser-, Smartphone- und lokale Geräteübertragung erhalten. Die experimentelle AirDrop/OpenDrop/OWL/AWDL-Kompatibilität wird in V19 bewusst vollständig aus Oberfläche, API und Systemkomponenten entfernt. LiLink besitzt in V19 zusätzlich einen systemweiten User-Service, Autostart und lokalen Health-Check.
...
`base1-ubuntu2604-full-whitesur-v19`

ISO:

`LiMaD-OS-3.0-RC1-BASE1-UBUNTU-26.04-FULL-WHITESUR-V19-amd64.iso`


## V19 Design-Sicherungen
