...
LiMaD OS 3.0 RC1 BASE1 DESIGN V18
...
Design V18: WhiteSur GTK, stock libadwaita with LiMaD traffic-light titlebuttons, compact centered Ubuntu Dock, LiLink/LiDrop GNOME 50 status icons, GDM logo/lockscreen, LiMaD Plymouth spinner watermark, GRUB branding
