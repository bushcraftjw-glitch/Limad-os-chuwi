...
Design V15: WhiteSur GTK, stock libadwaita with LiMaD traffic-light titlebuttons, compact centered Ubuntu Dock, LiLink/LiDrop GNOME 50 status icons, GDM logo/lockscreen, LiMaD Plymouth spinner watermark, GRUB branding
