...
deb [arch=amd64,i386 signed-by=$KEYRING] http://archive.ubuntu.com/ubuntu resolute-updates main restricted universe multiverse
deb [arch=amd64,i386 signed-by=$KEYRING] http://security.ubuntu.com/ubuntu resolute-security main restricted universe multiverse
EOF_SOURCES
