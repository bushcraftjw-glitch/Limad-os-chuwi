...
grep -Fq 'MODEL_PREVIEW_TRIANGLE_LIMIT = 40000' "$TMP/liview-stl.py"
grep -Fq 'MODEL_DRAFT_FACE_LIMIT = 8000' "$TMP/liview-stl.py"
grep -Fq 'MODEL_STANDARD_FACE_LIMIT = 24000' "$TMP/liview-stl.py"
grep -Fq 'max_faces = MODEL_DRAFT_FACE_LIMIT if self.preview_draft else MODEL_STANDARD_FACE_LIMIT' "$TMP/liview-stl.py"
